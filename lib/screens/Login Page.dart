    ...
    try {
      ...
      final userProfile = UserProfile(
        ...
        birthDate: user['date_of_birth'] != null
            ...
            : null,
        clinicName: user['clinic_name']?.toString(),
        licenseNumber: user['license_number']?.toString(),
        phone: (user['phone_number'] ?? user['phone'])?.toString(),
    ...
    try {
      ...
      if (isAssistant) {
        ...
        final updatedProfile = UserProfile(
          ...
          firstName: (assistantData['first_name'] ?? '').toString(),
          lastName: (assistantData['last_name'] ?? '').toString(),
          userType: 'assistant',
          ...
          birthDate: assistantData['date_of_birth'] != null
              ...
              : null,
          clinicName: assistantData['clinic_name']?.toString(),
          licenseNumber: null,
          phone: (assistantData['phone_number'] ?? assistantData['phone'])
              ?.toString(),
          region: assistantData['region']?.toString(),
          specialization: null,
